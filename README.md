...
- **Adult-content blocking on by default** — a large, actively-maintained pornography blocklist (HaGeZi NSFW, ~107K sites) is enabled out of the box, far stronger than AdGuard's built-in heuristic alone; toggle it off if your household doesn't want it
